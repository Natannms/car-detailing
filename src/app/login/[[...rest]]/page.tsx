        ...
        <div className="relative hidden lg:block">
          ...
          <div className="absolute bottom-12 left-12 right-12 text-white">
            <div className="max-w-md">
              <p className="text-2xl font-semibold leading-snug tracking-tight">“Simply all the tools that my team and I need.”</p>
              <div className="mt-5">
                <div className="text-sm font-semibold">Karen Yee</div>
                <div className="text-xs text-white/75">Director of Digital Marketing Technology</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex min-h-screen items-center justify-center bg-[#EEF1F6] px-6 py-12 lg:bg-white lg:px-12">
          <div className="w-full max-w-sm">
            <div className="mb-8 text-center">
              <h1 className="text-[28px] font-semibold tracking-tight text-gray-900">Welcome back to Kanban AI</h1>
              <p className="mt-2 text-sm text-gray-600">Entre para acessar seus projetos, backlog e dashboards.</p>
            </div>
