        ...
        <div className="flex min-h-screen items-center justify-center bg-[#EEF1F6] px-6 py-12 lg:bg-white lg:px-12">
          <div className="w-full max-w-sm">
            <div className="mb-8 text-center">
              <h1 className="text-[28px] font-semibold tracking-tight text-gray-900">Welcome back to Marca AI</h1>
              <p className="mt-2 text-sm text-gray-600">Entre para acessar seus projetos e dashboards.</p>
            </div>
