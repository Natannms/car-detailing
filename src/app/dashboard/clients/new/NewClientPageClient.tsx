...
export function NewClientPageClient({ returnTo }: { returnTo: string }) {
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0">
          <div className="flex items-center gap-3">
            <Link href={returnTo} className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-card shadow-sm ring-1 ring-border">
              <ArrowLeft size={18} weight="bold" />
            </Link>
            <div className="min-w-0">
              <h1 className="text-2xl font-semibold tracking-tight text-foreground">Cadastrar cliente</h1>
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" className="rounded-xl bg-card" onClick={() => router.push(returnTo)} disabled={saving}>
            Cancelar
          </Button>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="grid gap-2 md:col-span-2">
            ...
            <textarea
              ...
              rows={5}
              className="rounded-xl border border-border bg-card px-4 py-3 text-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20"
            />
          </div>
        </div>
      </div>
